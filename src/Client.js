...
class Client extends EventEmitter {
    ...
    async attachEventListeners() {
        ...
        await this.pupPage.evaluate(() => {
            ...
            Msg.on('change:type', (msg) => { if (msg.type !== 'revoked') return; window.onChangeMessageTypeEvent(window.WWebJS.getMessageModel(msg)); });
    ...
    async getProfilePicUrl(contactId) {
        const profilePic = await this.pupPage.evaluate(async contactId => {
            try {
                ...
                const contact = (window.require('WAWebCollections')).Contact.get(wid) || await (window.require('WAWebCollections')).Contact.find(wid);
